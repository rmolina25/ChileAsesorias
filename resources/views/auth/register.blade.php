                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="tipo_usuario" class="form-control @error('tipo_usuario') is-invalid @enderror" name="tipo_usuario" required>
                                    ...
                                    <option value="solicitante" {{ old('tipo_usuario') == 'solicitante' ? 'selected' : '' }}>{{ __('Solicitante') }}</option>
                                    <option value="asesor" {{ old('tipo_usuario') == 'asesor' ? 'selected' : '' }}>{{ __('Asesor') }}</option>
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="telefono" type="tel" class="form-control @error('telefono') is-invalid @enderror" name="telefono" value="{{ old('telefono') }}" autocomplete="tel">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="ciudad" type="text" class="form-control @error('ciudad') is-invalid @enderror" name="ciudad" value="{{ old('ciudad') }}" autocomplete="address-level2">
                        ...
                        <div class="row mb-3">
                            <label for="foto_perfil" class="col-md-4 col-form-label text-md-end">{{ __('Foto de Perfil') }}</label>

                            <div class="col-md-6">
                                <input id="foto_perfil" type="file" class="form-control @error('foto_perfil') is-invalid @enderror" name="foto_perfil" accept="image/*">
                                ...
                                <small class="form-text text-muted">
                                    {{ __('Formatos aceptados: JPG, PNG, GIF. Tamaño máximo: 2MB') }}
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    <input class="form-check-input @error('acepta_terminos') is-invalid @enderror" type="checkbox" name="acepta_terminos" id="acepta_terminos" {{ old('acepta_terminos') ? 'checked' : '' }}>

                                    <label class="form-check-label" for="acepta_terminos">
                                        {{ __('Acepto los términos y condiciones y la política de privacidad') }}
                                    </label>
